<x-guest-layout>
    <!-- Header Section -->
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-12 sm:py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl sm:text-4xl font-bold mb-4">Browse Gaming Rooms</h1>
            ...
            <form method="GET" action="{{ route('rooms.index') }}" class="flex flex-col sm:flex-row gap-3">
                ...
                @if(request('search') || request('sort'))
                    <a href="{{ route('rooms.index') }}"
                       class="px-6 py-2.5 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors font-medium text-center">
                        Reset
                    </a>
                @endif
            </form>
        ...
        @if($rooms->count() > 0)
            ...
            <div class="mb-6">
                <p class="text-gray-600">
                    ...
                    @if(request('search'))
                        untuk "<span class="font-semibold text-indigo-600">{{ request('search') }}</span>"
                    @endif
                </p>
            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden group">
                        ...
                        <div class="relative aspect-[4/3] overflow-hidden bg-gray-200">
                            ...
                            <div class="absolute bottom-3 left-3">
                                <span class="px-3 py-1 bg-white/90 backdrop-blur-sm text-gray-700 text-xs font-medium rounded-full shadow-md flex items-center gap-1">
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('rooms.show', $room->slug) }}"
                                   class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors shadow-md hover:shadow-lg">
                                    Lihat
