    ...
    <div class="bg-gray-50 border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex items-center space-x-2 text-sm">
                ...
                <a href="{{ route('rooms.index') }}" class="text-gray-500 hover:text-gray-700">Rooms</a>
                <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                </svg>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                    ...
                    <div class="relative aspect-[16/10] rounded-2xl overflow-hidden bg-gray-200 mb-4 shadow-xl">
                        @if($room->images->count() > 0)
                            ...
                            @if($room->images->count() > 1)
                                ...
                                <!-- Image Counter -->
                                <div class="absolute bottom-4 right-4 px-3 py-1.5 bg-black/70 backdrop-blur-sm text-white text-sm rounded-lg">
                        ...
                        <div class="grid grid-cols-4 gap-3">
                            @foreach($room->images as $index => $image)
                                <button @click="currentImage = {{ $index }}"
                                        :class="currentImage === {{ $index }} ? 'ring-4 ring-indigo-500' : 'ring-2 ring-transparent hover:ring-gray-300'"
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
                    ...
                    <div>
                        ...
                        <div class="prose prose-indigo max-w-none">
                            <p class="text-gray-700 leading-relaxed whitespace-pre-line">{{ $room->description }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="flex items-center gap-3 text-gray-700">
                                ...
                                <span class="font-medium">High-End Gaming PC/Console</span>
                            </div>
                            <div class="flex items-center gap-3 text-gray-700">
                                <div class="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    ⚡
                            ...
                            <div class="flex items-center gap-3 text-gray-700">
                                ...
                                <span class="font-medium">Gaming Chair Ergonomis</span>
                            </div>
                            <div class="flex items-center gap-3 text-gray-700">
                                <div class="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    🎧
                                </div>
                                <span class="font-medium">Headset Gaming</span>
                            </div>
                            <div class="flex items-center gap-3 text-gray-700">
                                <div class="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    🍕
                ...
                @if($relatedRooms->count() > 0)
                    <div class="mt-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Room Lainnya</h2>
                                   ...
                                   class="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow overflow-hidden group">
                                    <div class="relative aspect-[4/3] overflow-hidden bg-gray-200">
                                        @if($related->thumbnail)
                                            <img src="{{ asset('storage/' . $related->thumbnail->image_path) }}"
                                                 alt="{{ $related->name }}"
                                    ...
                                    <div class="p-4">
                                        ...
                                        <p class="text-sm text-indigo-600 font-semibold">
                                            Rp {{ number_format($related->price_per_hour, 0, ',', '.') }}/jam
                                        </p>
                                    </div>
                                </a>
                            @endforeach
                ...
                <div class="bg-white rounded-2xl shadow-xl p-6 sticky top-24">
                    ...
                    @auth
                        <a href="{{ route('booking.index') }}?room={{ $room->id }}"
                           class="block w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-center font-bold rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                            Booking Sekarang
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="tel:08123456789"
                               class="flex items-center gap-3 text-sm text-gray-700 hover:text-indigo-600 transition-colors">
